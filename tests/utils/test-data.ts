...
export const TestData = {
  ...
  invalidEmails: ["invalid-email", "@domain.com", "user@", "spaces in@email.com"],

  validPasswords: ["Password123!", "SecureP@ssw0rd", "MyStr0ng!Password"],
  ...
  validNames: ["John Doe", "Alice Smith", "Bob Johnson", "María García", "Jean-Pierre Dupont"],
} as const;
